...
namespace OrderService.Infrastructure.Context
{
    ...
    {
        private static string ConnectionString = "Data Source=c_sqlserver;Initial Catalog=Order;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False";
