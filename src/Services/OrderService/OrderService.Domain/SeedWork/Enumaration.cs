...
namespace OrderService.Domain.SeedWork
{
    public abstract class Enumaration : IComparable
    {
        ...
        {
            if (obj is not Enumaration otherValue)
                return false;
        ...
        public static int AbsoluteDifference(Enumaration firtsValue, Enumaration secondValue)
        {
            var absoluteDifference = Math.Abs(firtsValue.Id - secondValue.Id);
